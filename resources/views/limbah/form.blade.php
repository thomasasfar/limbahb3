    ...
    <div class="container">
        ...
        <table style="border: 1px solid black;">
            ...
            <tr>
                ...
                <td colspan="2" style="text-align:center">{{$m->jml_masuk}} Kg</td>
        ...
        <p><b>Note:</b> Jumlah limbah masuk telah dikonversi ke dalam satuan kg.</p>
        ...
        <table style="border: 1px solid white;">
            ...
            <tr style="border: 1px solid white;" style="text-align: center;font-weight:bold">
                <td colspan="3" style="text-align: center"><br>
                    ...
                    <img style="width:60px;" src="data:image/png;base64,{{$qrcode_kaunit}}" alt="QR Code Menyerahkan">
                    <br>{{$aktivitas_limbah->user->penanggung_jawab}}
                </td>
            </tr>
            <tr style="border: 1px solid white;">
            ...
            <tr style="text-align: center;font-weight:bold;style;border: 1px solid white;">
                <td colspan=" 3" style="text-align:center;"><br>
                    <div>
                        ...
                        <img style="width:60px;" src="data:image/png;base64,{{$qrcode_menerima}}"
                            alt="QR Code Menyerahkan">
                    </div>
                    <br>{{$aktivitas_limbah->menerima}}
                </td>
                <td colspan="3" style="text-align:center;">

                    <br><img style="width:60px;" src="data:image/png;base64,{{$qrcode_menyerahkan}}"
                        alt="QR Code Menyerahkan"><br>{{$aktivitas_limbah->menyerahkan}}
                </td>
            </tr>
            <tr style="border: 1px solid white;">
