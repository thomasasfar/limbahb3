...
<div class="modal fade" id="limbahModal" tabindex="-1" aria-labelledby="limbahModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title fw-bold" id="limbahModalLabel">Limbah Keluar</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="/limbah" method="POST" onsubmit="return validateSignatures()">
                    @csrf
                    <label for="" class="form-label">Data Limbah</label>
                    ...
                    <div class="mmb-3">
                        <label for="">Pilih Perlakuan Limbah</label>
                        <select class="form-control" name="perlakuan" id="">
                            <option value="disimpan">Disimpan</option>
                            <option value="dimanfaatkan_sendiri">Dimanfaatkan Sendiri</option>
                            <option value="diolah_sendiri">Diolah Sendiri</option>
                            <option value="ditimbun_sendiri">Ditimbun Sendiri</option>
                            <option value="tidak_dikelola">Tidak Dikelola</option>
                        </select>
                    </div>
                    ...
                    <button type="submit" class="btn btn-primary">Tambah Data Limbah Keluar</button>
                </form>
            </div>
        </div>
    </div>
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('limbah.klasifikasi') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="" name="jenis_limbah" required>
                    </div>
                    <div class="form-group">
                        <label for="">Kode Limbah</label>
                        <input type="text" class="form-control" id="" name="kode_limbah" required>
                    </div>
                    <div class="form-group">
                        <label for="">Satuan</label>
                        <input type="text" class="form-control" id="" name="satuan" required>
                    </div>
                    <div class="form-group">
                        <label for="">Konversi ke Kg</label>
